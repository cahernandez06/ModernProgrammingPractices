...
public class Examples {
	...
	private void evaluator() {
		Employee employee1 = new Employee("Victor", 300000);
		...
		System.out.println("setName to: Sebastian");
		...
		System.out.println(comparatorEmployee1.compare(employee1, new Employee("Victor", 300000)));
		System.out.println("----");
