package FinalTest.Final1.problem1.partB;
...
public class PartB {
	...
	Function<CheckoutRecord,List<CheckoutRecordEntry>> FunctionLamda =(CheckoutRecord record) -> record.getCheckoutEntries() ;
	
	//provide a method reference and the type of method reference
	//TYPE: obj::instanceMethod
	Function<CheckoutRecord,List<CheckoutRecordEntry>> FunctionWithMethodRe = CheckoutRecord::getCheckoutEntries;
	...
	public void evaluator() {
		...
		System.out.println("FunctionLamda : "+ FunctionLamda.apply(record));
		System.out.println("FunctionWithMethodRe : " +FunctionWithMethodRe.apply(record));
		System.out.println("nestedClass : "+ new MyClass().apply(record));
	}
