...
public class Employee {
	...
	public static void main(String[] args) {
		...
		Function<Employee, Integer> bySalary = x -> x.getSalary()*-1;
		...
		//System.out.println(list.stream().sorted(Comparator.comparing(byName).thenComparing(bySalary).reversed()).collect(Collectors.toList()));
		System.out.println(list.stream().sorted(Comparator.comparing(byName).thenComparing(bySalary)).collect(Collectors.toList()));
	}
}
